                ...
                {customLayout === "centred" ? (
                  ...
                  <div className="flex flex-col relative z-10 pb-6">
                    <div className="flex flex-col px-6 pt-6">
                      ...
                      <h1 style={{ fontFamily:fontFam,fontSize:"clamp(42px,11vw,72px)",fontWeight:900,color:tCol,lineHeight:0.95,marginBottom:"10px",textShadow:isLight?"none":"0 2px 12px rgba(0,0,0,0.5)" }}>{event.title||"Untitled Event"}</h1>
                      <p style={{ fontFamily:"'Inter',sans-serif",fontSize:"12px",color:tMuted,marginBottom:"14px" }}>hosted by {hostName}</p>
                  ...
                  <div className="flex flex-col items-center text-center relative z-10 pb-6">
                    <div className="flex flex-col items-center text-center px-5 pt-6">
                      ...
                      <h1 style={{ fontFamily:fontFam,fontSize:titleSz,fontWeight:titleWt,color:tCol,lineHeight:1.05,marginBottom:"6px",textShadow:isLight?"none":"0 1px 8px rgba(0,0,0,0.5)" }}>{event.title||"Untitled Event"}</h1>
                      <p style={{ fontFamily:"'Inter',sans-serif",fontSize:"12px",color:tMuted,marginBottom:"18px" }}>hosted by {hostName}</p>
                      {eventDate && <div style={{ borderRadius:"50px",border:`1px solid ${frostBorder}`,padding:"8px 18px",backgroundColor:frostBg,backdropFilter:"blur(12px)",WebkitBackdropFilter:"blur(12px)",marginBottom:"18px",display:"inline-block" }}><span style={{ fontFamily:fontFam,fontSize:"15px",fontWeight:titleWt,color:accentColor }}>{dayNum} {monthName}<span style={{ color:tMuted,margin:"0 8px" }}>·</span>{timeStr}<span style={{ color:tMuted,margin:"0 8px" }}>·</span>{goingList.length} going</span></div>}
                    </div>
                    <div className="w-full flex flex-col gap-3 px-5">
                      {event.location && <div style={infoBubbleStyle}><p style={{ fontFamily:"'Inter',sans-serif",fontSize:"8px",fontWeight:700,letterSpacing:"0.22em",textTransform:"uppercase" as const,color:infoLabelColor,marginBottom:"5px" }}>Location</p><p style={{ fontFamily:fontFam,fontSize:"18px",fontWeight:titleWt,color:infoTextColor,lineHeight:1.2 }}>{event.location}</p></div>}
                      {event.dress_code && <div style={infoBubbleStyle}><p style={{ fontFamily:"'Inter',sans-serif",fontSize:"8px",fontWeight:700,letterSpacing:"0.22em",textTransform:"uppercase" as const,color:infoLabelColor,marginBottom:"5px" }}>Dress Code</p><p style={{ fontFamily:fontFam,fontSize:"18px",fontWeight:titleWt,color:infoTextColor,lineHeight:1.2 }}>{event.dress_code}</p></div>}
