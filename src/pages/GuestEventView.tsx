  ...
  const renderPolls = () => {
    ...
    <div className="mt-3 space-y-3">
      {visible.map(poll => {
        ...
        return (
        <div key={poll.id} className="rounded-2xl p-4" style={{ backgroundColor: isLightBg ? "rgba(0,0,0,0.05)" : "rgba(255,255,255,0.10)", border: `1px solid ${isLightBg ? "rgba(0,0,0,0.08)" : "rgba(255,255,255,0.14)"}` }}>
      ...
      {isNoir ? (
        ...
        <>
          {(() => {
            ...
            const infoTextColor = bubbleStyleVal === "solid" ? `hsl(${(event as any).bubble_text_color || "0 0% 0%"})` : tCol;
            const infoLabelColor = bubbleStyleVal === "solid" ? `hsl(${(event as any).bubble_text_color || "0 0% 0%"})` : accentColor;
            return (
                ...
                {customLayout === "ocean" ? (
                  <div className="relative z-10 pb-6">
                    <div className="relative z-10 px-5 pt-6 pb-2 text-center">
                      ...
                      <h1 style={{ fontFamily:fontFam,fontSize:titleSz,fontWeight:900,color:tCol,lineHeight:1.1,marginBottom:"8px" }}>{event.title||"Untitled Event"}</h1>
                      ...
                      <p style={{ fontFamily:"'Inter',sans-serif",fontSize:"11px",color:tMuted,marginBottom:"16px" }}>hosted by {hostName}</p>
                      <svg viewBox="0 0 320 20" style={{ width:"100%",maxWidth:"280px",margin:"0 auto",display:"block",marginBottom:"20px" }}>
                    ...
                    <div className="flex flex-col gap-3 px-5">
                      <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:"8px" }}>
                        <div style={{ ...infoBubbleStyle,borderRadius:"16px",padding:"14px 8px",textAlign:"center" as const }}><p style={{ fontFamily:"'Inter',sans-serif",fontSize:"7px",fontWeight:700,letterSpacing:"0.22em",textTransform:"uppercase" as const,color:infoLabelColor,marginBottom:"4px" }}>Day</p><span style={{ fontFamily:fontFam,fontSize:"34px",fontWeight:900,color:infoTextColor,lineHeight:1,display:"block" }}>{dayNum||"—"}</span><p style={{ fontFamily:"'Inter',sans-serif",fontSize:"9px",fontWeight:700,color:infoLabelColor,textTransform:"uppercase" as const,marginTop:"2px" }}>{monthName||"TBD"}</p></div>
                        <div style={{ ...infoBubbleStyle,borderRadius:"16px",padding:"14px 8px",textAlign:"center" as const }}><p style={{ fontFamily:"'Inter',sans-serif",fontSize:"7px",fontWeight:700,letterSpacing:"0.22em",textTransform:"uppercase" as const,color:infoLabelColor,marginBottom:"4px" }}>Time</p><span style={{ fontFamily:fontFam,fontSize:eventDate?"16px":"28px",fontWeight:900,color:infoTextColor,lineHeight:1.1,display:"block" }}>{timeStr||"—"}</span><p style={{ fontFamily:"'Inter',sans-serif",fontSize:"9px",fontWeight:700,color:infoLabelColor,textTransform:"uppercase" as const,marginTop:"2px" }}>{dayOfWeek?dayOfWeek.slice(0,3).toUpperCase():"TBD"}</p></div>
                        <div style={{ ...infoBubbleStyle,borderRadius:"16px",padding:"14px 8px",textAlign:"center" as const }}><p style={{ fontFamily:"'Inter',sans-serif",fontSize:"7px",fontWeight:700,letterSpacing:"0.22em",textTransform:"uppercase" as const,color:infoLabelColor,marginBottom:"4px" }}>Going</p><span style={{ fontFamily:fontFam,fontSize:"34px",fontWeight:900,color:infoTextColor,lineHeight:1,display:"block" }}>{goingList.length}</span><p style={{ fontFamily:"'Inter',sans-serif",fontSize:"9px",fontWeight:700,color:infoLabelColor,textTransform:"uppercase" as const,marginTop:"2px" }}>Guests</p></div>
                      </div>
                  ...
                  <div className="flex flex-col relative z-10 pb-6">
                    <div className="flex flex-col px-6 pt-6">
                      ...
                      <h1 style={{ fontFamily:fontFam,fontSize:titleSz,fontWeight:900,color:tCol,lineHeight:0.95,marginBottom:"10px",textShadow:isLight?"none":"0 2px 12px rgba(0,0,0,0.5)" }}>{event.title||"Untitled Event"}</h1>
                      <p style={{ fontFamily:"'Inter',sans-serif",fontSize:customHostedBySz,color:tMuted,marginBottom:"14px" }}>hosted by {hostName}</p>
                      <div style={{ width:"48px",height:"3px",backgroundColor:accentColor,marginBottom:"16px",borderRadius:"2px" }} />
                      {eventDate && <p style={{ fontFamily:"'Inter',sans-serif",fontSize:"14px",color:tCol,marginBottom:"10px",fontWeight:500 }}>📅 {dayNum} {monthName} · {timeStr} · {goingList.length} going</p>}
                      {event.location && <p style={{ fontFamily:"'Inter',sans-serif",fontSize:"14px",color:infoTextColor,marginBottom:"8px" }}>📍 {event.location}</p>}
                      {event.dress_code && <p style={{ fontFamily:"'Inter',sans-serif",fontSize:"14px",color:infoTextColor,marginBottom:"8px" }}>👗 {event.dress_code}</p>}
                  ...
                  <div className="flex flex-col items-center text-center relative z-10 pb-6">
                    <div className="flex flex-col items-center text-center px-5 pt-6">
                      ...
                      <p style={{ fontFamily:"'Inter',sans-serif",fontSize:customHostedBySz,color:tMuted,marginBottom:"18px" }}>hosted by {hostName}</p>
                      {eventDate && <div style={{ borderRadius:"50px",border:`1px solid ${frostBorder}`,padding:"8px 18px",backgroundColor:frostBg,backdropFilter:"blur(12px)",WebkitBackdropFilter:"blur(12px)",marginBottom:"18px",display:"inline-block" }}><span style={{ fontFamily:fontFam,fontSize:customValueSz,fontWeight:titleWt,color:accentColor }}>{dayNum} {monthName}<span style={{ color:tMuted,margin:"0 8px" }}>·</span>{timeStr}<span style={{ color:tMuted,margin:"0 8px" }}>·</span>{goingList.length} going</span></div>}
                    </div>
