                  ...
                  <div className="relative z-10 pb-6">
                    ...
                    <div className="flex flex-col gap-3 px-5">
                      <div className="flex gap-3">
                        ...
                        {event.dress_code && <div className="flex-1 flex flex-col overflow-hidden" style={{ ...infoBubbleStyle,borderRadius:"14px",padding:"12px 12px" }}><span style={{ fontFamily:"'Playfair Display',serif",fontSize:"9px",fontWeight:600,color:infoLabelColor,textTransform:"uppercase" as const,letterSpacing:"0.15em" }}>Dress Code</span><span className="mt-1" style={{ fontFamily:"'Playfair Display',serif",fontSize:"16px",fontWeight:700,color:infoTextColor }}>{event.dress_code}</span></div>}
                      </div>
                      {event.location && <div className="flex items-center gap-3" style={{ ...infoBubbleStyle,borderRadius:"14px",padding:"14px 16px" }}><div className="flex items-center justify-center shrink-0" style={{ width:"36px",height:"36px",borderRadius:"8px",backgroundColor:accentColor }}><span style={{ fontSize:"18px" }}>📍</span></div><div className="flex-1 min-w-0"><span style={{ fontFamily:"'Playfair Display',serif",fontSize:"9px",fontWeight:600,color:infoLabelColor,textTransform:"uppercase" as const,letterSpacing:"0.15em",display:"block" }}>Location</span><span className="block truncate mt-0.5" style={{ fontFamily:"'Playfair Display',serif",fontSize:"16px",fontWeight:700,color:infoTextColor }}>{event.location}</span></div><span style={{ color:"rgba(255,255,255,0.2)",fontSize:"20px",fontWeight:300 }}>›</span></div>}
                      {event.extra && <div className="flex items-start gap-3" style={{ ...infoBubbleStyle,borderRadius:"14px",padding:"14px 16px" }}><span style={{ color:accentColor,fontSize:"14px",marginTop:"1px" }}>✦</span><div className="flex-1"><span style={{ fontFamily:"'Playfair Display',serif",fontSize:"9px",fontWeight:600,color:infoLabelColor,textTransform:"uppercase" as const,letterSpacing:"0.15em",display:"block" }}>Note from host</span><span className="block mt-1" style={{ fontFamily:"'Playfair Display',serif",fontSize:"14px",fontStyle:"italic",color:infoTextColor }}>{event.extra}</span></div></div>}
