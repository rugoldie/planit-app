            ...
            <div className="px-5 flex flex-col gap-3 relative z-10 pb-6">
              ...
              >
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <button
                    type="button" onPointerDown={(e) => { e.preventDefault(); sendComment(); }}
            ...
            <div className="px-5 pb-10 relative z-10 flex flex-col gap-3">
              ...
              <div style={{ backgroundColor: "rgba(56,189,248,0.06)", border: "1px solid rgba(56,189,248,0.12)", borderRadius: "16px", padding: "12px 14px" }}>
                ...
                <div className="flex gap-2">
                  ...
                  <button type="button" onPointerDown={(e) => { e.preventDefault(); sendComment(); }} className="w-11 h-11 rounded-full flex items-center justify-center shrink-0" style={{ backgroundColor: "rgb(56,189,248)" }}>
            ...
            <div className="px-5 pt-4 pb-10 relative z-10 flex flex-col gap-3">
              ...
              <div style={{ backgroundColor: "rgba(244,114,182,0.06)", border: "1px solid rgba(244,114,182,0.15)", borderRadius: "12px", padding: "12px 14px" }}>
                ...
                <div className="flex gap-2">
                  ...
                  <button type="button" onPointerDown={(e) => { e.preventDefault(); sendComment(); }} className="w-11 h-11 rounded-full flex items-center justify-center shrink-0" style={{ backgroundColor: "#f472b6" }}>
            ...
            <div className="px-5 pb-10 relative z-10 flex flex-col gap-3">
              ...
              <div style={{ border: "1px solid rgba(74,222,128,0.18)", borderRadius: "12px", padding: "12px 14px" }}>
                ...
                <div className="flex gap-2">
                  ...
                  <button type="button" onPointerDown={(e) => { e.preventDefault(); sendComment(); }} className="w-11 h-11 rounded-full flex items-center justify-center shrink-0" style={{ backgroundColor: "#4ade80" }}>
                ...
                <div className="flex flex-col items-center text-center px-5 pt-6 pb-6 relative z-10">
                  ...
                  {eventDate && (
                    <div style={{ borderRadius: "50px", border: `1px solid ${frostBorder}`, padding: "8px 18px", backgroundColor: frostBg, backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", marginBottom: "18px", display: "inline-block" }}>
                      <span style={{ fontFamily: eventFontFamily, fontSize: "15px", fontWeight: titleWt, color: accentColor, letterSpacing: event.font_style==="Bold"?"0.05em":0 }}>
                        {dayNum} {monthName}
                  ...
                  <div className="w-full flex flex-col gap-3">
                    {event.location && (
                      <div style={{ borderRadius: "20px", border: `1px solid ${frostBorder}`, padding: "16px 18px", backgroundColor: frostBg, backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)" }}>
                        ...
                        <p style={{ fontFamily: eventFontFamily, fontSize: "18px", fontWeight: titleWt, color: tCol, lineHeight: 1.2 }}>{event.location}</p>
                      </div>
                    )}
                    {event.dress_code && (
                      <div style={{ borderRadius: "20px", border: `1px solid ${frostBorder}`, padding: "16px 18px", backgroundColor: frostBg, backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)" }}>
                        ...
                        <p style={{ fontFamily: eventFontFamily, fontSize: "18px", fontWeight: titleWt, color: tCol, lineHeight: 1.2 }}>{event.dress_code}</p>
                      </div>
                    )}
                    {event.extra && (
                      <div style={{ borderRadius: "20px", border: `1px solid ${frostBorder}`, padding: "16px 18px", backgroundColor: frostBg, backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)" }}>
                    ...
                    <div style={{ borderRadius: "20px", border: `1px solid ${frostBorder}`, padding: "16px 18px", backgroundColor: frostBg, backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)" }}>
                      ...
                      <div className="flex gap-2">
                        ...
                        <button type="button" onPointerDown={(e) => { e.preventDefault(); sendComment(); }} className="w-11 h-11 rounded-full flex items-center justify-center shrink-0" style={{ backgroundColor: accentColor }}>
            ...
            <>
              ...
              <div className="px-4 py-3 border-t border-border flex gap-2">
                <input
                  ...
                  style={{ backgroundColor: "#383838" }}
                />
                <button type="button" onPointerDown={(e) => { e.preventDefault(); sendDM(); }} className="w-11 h-11 rounded-full bg-primary flex items-center justify-center">
                  <Send className="w-4 h-4 text-primary-foreground" />
                </button>
              </div>
            </>
